...
async fn test_cleanup_query_includes_vine_id_check() {
    // This test documents the expected behavior of the cleanup query
    // The actual query in bcrypt_queue.rs should be:
    ...
    // Read the actual source file and verify it contains these conditions
